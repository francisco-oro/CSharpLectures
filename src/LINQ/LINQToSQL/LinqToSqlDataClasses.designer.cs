...
namespace LINQToSQL
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="FranciscoDB")]
    ...
    partial void InsertStudentLecutre(StudentLecutre instance);
    partial void UpdateStudentLecutre(StudentLecutre instance);
    partial void DeleteStudentLecutre(StudentLecutre instance);
    #endregion
		
		public LinqToSqlDataClassesDataContext() : 
				base(global::LINQToSQL.Properties.Settings.Default.FranciscoDBConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<StudentLecutre> StudentLecutre
		{
			get
			{
				return this.GetTable<StudentLecutre>();
			}
		}
	}
	...
	public partial class Student : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<StudentLecutre> _StudentLecutre;
    ...
    partial void OnUniversityIdChanged();
		...
		public Student()
		{
			this._StudentLecutre = new EntitySet<StudentLecutre>(new Action<StudentLecutre>(this.attach_StudentLecutre), new Action<StudentLecutre>(this.detach_StudentLecutre));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Student_StudentLecutre", Storage="_StudentLecutre", ThisKey="Id", OtherKey="StudentId")]
		public EntitySet<StudentLecutre> StudentLecutre
		{
			get
			{
				return this._StudentLecutre;
			}
			set
			{
				this._StudentLecutre.Assign(value);
			}
		}
		...
		private void attach_StudentLecutre(StudentLecutre entity)
		{
			this.SendPropertyChanging();
			entity.Student = this;
		}
		
		private void detach_StudentLecutre(StudentLecutre entity)
		{
			this.SendPropertyChanging();
			entity.Student = null;
		}
    ...
    partial void OnNameChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Lecture_StudentLecutre", Storage="_StudentLecutre", ThisKey="Id", OtherKey="LectureId")]
		public EntitySet<StudentLecutre> StudentLecutre
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.StudentLecutre")]
	public partial class StudentLecutre : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnLectureIdChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Lecture_StudentLecutre", Storage="_Lecture", ThisKey="LectureId", OtherKey="Id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
			...
			set
			{
							...
							|| (this._Lecture.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.StudentLecutre.Remove(this);
					}
					this._Lecture.Entity = value;
					if ((value != null))
					{
						value.StudentLecutre.Add(this);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Student_StudentLecutre", Storage="_Student", ThisKey="StudentId", OtherKey="Id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
